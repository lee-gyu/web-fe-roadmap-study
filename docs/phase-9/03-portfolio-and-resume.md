...
이 문장은 문제, 제약, 선택, 측정, 한계를 함께 보여 준다. Phase 9의 포트폴리오와 이력서는 바로 이 압축을 목표로 한다.
...
이 흐름은 [9-1](./01-project-guide.md)의 요구사항·ADR과 [9-2](./02-code-quality-and-review.md)의 리뷰·검증 기록을 외부 독자에게 읽히는 형태로 바꾼 것이다.
